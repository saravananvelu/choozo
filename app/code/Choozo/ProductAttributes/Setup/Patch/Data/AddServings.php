<?php
/**
 *  Patch script class for creating Servings attribute
 *
 * PHP version 7.4
 *
 * @category  Magento
 ...
 * @link      http://www.choo.com
 */
class AddServings implements DataPatchInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $this->dataInstallerFactory->create()->convertAttributeToSwatches('servings');
