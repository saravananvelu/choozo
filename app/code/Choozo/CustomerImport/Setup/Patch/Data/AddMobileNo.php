<?php
/**
 *  Patch script class for creating mobile no attribute
 *
 * PHP version 7.4
 *
 * @category  Magento
...
/**
 *  Patch script class for creating mobile attribute
 *
 * PHP version 7.4
 *
 * @category  Magento
...
class AddMobileNo implements DataPatchInterface
{
    ...
    public function apply()
    {
        ...
        $newAttribute = $this->eavConfig->getAttribute(Customer::ENTITY, 'mobile_no');
